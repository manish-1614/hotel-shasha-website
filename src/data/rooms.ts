...
export const rooms: Room[] = [
  {
    ...
    image: '/images/room/rustic-wooden-bedroom-homestay-desktop.webp',
    gallery: [
      '/images/room/rustic-wooden-bedroom-homestay-desktop.webp',
      '/images/room/cozy-wooden-room-forest-view-desktop.webp',
      '/images/room/cozy-homestay-window-view-desktop.webp',
    ...
    variants: [
      {
        ...
        occupancy: '1 guest',
        priceRoomOnly: 800,
        priceCpPerPerson: 1350,
      },
    ],
    gradient: 'from-forest to-forest-light',
    image: '/images/room/wooden-bunk-beds-room-desktop.webp',
    gallery: [
      '/images/room/wooden-bunk-beds-room-desktop.webp',
      '/images/room/homestay-dorm-bunk-beds-room-desktop.webp',
      '/images/room/homestay-lounge-room-desktop.webp',
      '/images/room/traditional-homestay-lounge-room-desktop.webp',
      '/images/room/cozy-wooden-loft-room-desktop.webp',
      '/images/amenities/homestay-equipped-kitchen-desktop.webp',
    ],
  },
]
