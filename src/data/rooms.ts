...
export const rooms: Room[] = [
  {
    ...
    image: '/images/room/cozy-wooden-homestay-room.webp',
    gallery: [
      '/images/room/cozy-wooden-homestay-room.webp',
      '/images/room/cozy-window-forest-view.webp',
      '/images/room/cozy-wooden-bedroom-view.webp',
      '/images/bathroom/homestay-bathroom-interior.webp',
      '/images/bathroom/homestay-washroom-area.webp',
      '/images/exterior/mountain-scenic-beauty-exterior-village.webp',
    ],
  },
  {
    slug: 'private-rooms',
    ...
    image: '/images/room/cozy-double-bedroom.webp',
    gallery: [
      '/images/room/cozy-double-bedroom.webp',
      '/images/room/homestay-double-bedroom.webp',
      '/images/room/cozy-rustic-homestay-bedroom.webp',
      '/images/bathroom/homestay-bathroom-shower-toilet.webp',
      '/images/room/cozy-window-seat-nature.webp',
      '/images/room/wooden-homestay-staircase.webp',
    ],
  },
  {
    slug: 'dorm',
    ...
    image: '/images/room/wooden-bunk-beds-room.webp',
    gallery: [
      '/images/room/wooden-bunk-beds-room.webp',
      '/images/room/wooden-bunk-bed-dorm-room.webp',
      '/images/room/homestay-common-lounge-room.webp',
      '/images/room/traditional-homestay-lounge.webp',
      '/images/room/wooden-loft-bedroom.webp',
      '/images/room/homestay-kitchen-interior.webp',
    ],
  },
]
